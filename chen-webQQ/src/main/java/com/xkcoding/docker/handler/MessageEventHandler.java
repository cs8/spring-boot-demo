package com.xkcoding.docker.handler;
...
import com.xkcoding.docker.config.DbTemplate;
import com.xkcoding.docker.config.Event;
import com.xkcoding.docker.controller.HelloController;
import com.xkcoding.docker.payload.BroadcastMessageRequest;
import com.xkcoding.docker.payload.GroupMessageRequest;
import com.xkcoding.docker.payload.JoinRequest;
import com.xkcoding.docker.payload.SingleMessageRequest;
...
public class MessageEventHandler {
    ...
    public void onChatEvent(SocketIOClient client, AckRequest request, SingleMessageRequest data) {
        ...
        //存储数据库
       helloController.addMessage(client.getSessionId()+"",data.getMessage());
